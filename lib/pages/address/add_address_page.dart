...
import 'package:foddies_app/models/address_model.dart';
import 'package:foddies_app/pages/address/pick_address_map.dart';
...
class _AddAddressPageState extends State<AddAddressPage> {
  ...
  CameraPosition _cameraPosition =
      CameraPosition(target: LatLng(45.51564, -122.677433), zoom: 17);
  late LatLng _initialPosition = LatLng(45.51564, -122.677433);
        ...
        builder: (userController) {
          ...
          return GetBuilder<LocationController>(
            builder: (locationController) {
              ...
              print("My Address in view: " + _addressController.text);
                      ...
                      Container(
                        ...
                        child: Stack(children: [
                          GoogleMap(
                            ...
                            onCameraIdle: () {
                              print("here" + locationController.toString());
...
// המידע מתרפרש רק שנכנסים לדף של היוזר